                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="view_student.php" class="btn btn-sm btn-success me-3"><i class="fa fa-eye"></i></a>
                                <a href="admission_list.php?id=<?=$data['id']; ?>&status=0" class="btn btn-sm btn-danger me-3"><i class="fa fa-times text-danger text-white"></i></a>
